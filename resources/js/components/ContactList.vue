    ...
    <div class="container mx-auto p-4">
      ...
      <div class="overflow-x-auto">
        <table class="min-w-full bg-white">
          ...
          <tbody>
            <tr v-for="contact in contacts" :key="contact.id" class="border-t">
              ...
              <td class="py-2 px-4 space-x-1">
                ...
                <button @click="deleteContact(contact.id)" class="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-2 rounded">
                  Delete
                </button>
              </td>
            </tr>
